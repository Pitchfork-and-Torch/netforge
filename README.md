...
[![Version](https://img.shields.io/badge/version-2.1.0-informational)](VERSION)

Local-first. Zero telemetry. Prefer Ethernet, resilient DNS, TCP tuning, optional hardening.

Apply path and source of truth: this monorepo (`VERSION` **2.1.0**). The former split repos (`netforge-windows`, `netforge-linux`, `netforge-macos`) are archived stubs.
...
Each platform ships `home`, `travel`, `corporate`, and `privacy-max` configs. Start with a dry-run, then install.

## Related Pitchfork-and-Torch tools

| Tool | Role |
|------|------|
| [trench-coat](https://github.com/Pitchfork-and-Torch/trench-coat) ([site](https://trenchcoat.jonbailey.xyz/)) | Multi-hop privacy cloak |
| [ghost-continuum](https://github.com/Pitchfork-and-Torch/ghost-continuum) ([site](https://ghost.jonbailey.xyz/)) | Defense / deception / forensics |
...
| [SkyCache](https://github.com/Pitchfork-and-Torch/SkyCache) ([site](https://skycache.jonbailey.xyz/)) | Receive-only community satellite hub |
