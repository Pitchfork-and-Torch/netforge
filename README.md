...
[![Version](https://img.shields.io/badge/version-2.1.1-informational)](VERSION)

Local-first. Zero telemetry. Prefer Ethernet, resilient DNS, TCP tuning, optional hardening.

Apply path and source of truth: this monorepo (`VERSION` **2.1.1**). The former split repos (`netforge-windows`, `netforge-linux`, `netforge-macos`) are archived stubs.
