...
| Platform | Path in monorepo | Install | Status (read-only) |
|----------|------------------|---------|----------------------|
| Windows 10/11 | [windows/](windows/) | `windows/src/Install-NetworkAuto.ps1` | `windows/src/Get-NetForgeStatus.ps1` |
| Linux (NetworkManager) | [linux/](linux/) | `linux/src/install-network-auto.sh` | `linux/src/netforge-status.sh` |
| macOS 12+ | [macos/](macos/) | `macos/src/install-network-auto.sh` | `macos/src/netforge-status.sh` |

Monorepo: [Pitchfork-and-Torch/netforge](https://github.com/Pitchfork-and-Torch/netforge)
...
Bug reports via the monorepo [GitHub Issues](https://github.com/Pitchfork-and-Torch/netforge/issues). MIT licensed.
