...
Clone and read `src/network-auto.sh` before running. Install only from [github.com/Pitchfork-and-Torch/netforge](https://github.com/Pitchfork-and-Torch/netforge). Prefer `./src/netforge-status.sh` (read-only) before elevating.
