...
Open a [GitHub issue](https://github.com/Pitchfork-and-Torch/netforge/issues). For sensitive findings, use GitHub private vulnerability reporting if enabled.
...
If hotel/airport Wi-Fi will not show a login page after NetForge DNS changes, run **`.\src\Clear-CaptivePortal.ps1`** (elevated), authenticate, then re-run the normal NetForge apply script.
